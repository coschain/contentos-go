...
func (srv *Server) Start() (err error) {
	...
	*/
	...
	if err != nil {
		fmt.Println("Can't create p2p log file...", err)
		return err
	}
	srv.log = log.New()
...
func (srv *Server) startListening() error {
	...
	if !laddr.IP.IsLoopback() && srv.NAT != nil {
		srv.loopWG.Add(1)
		go func() {
			nat.Map(srv.NAT, srv.quit, "tcp", laddr.Port, laddr.Port, "contentos p2p")
			srv.loopWG.Done()
		}()
	}
	return nil
...
func (srv *Server) run(dialstate dialer) {
	...
	// define a function to remove a task from runningTasks
	delTask := func(t task) {
