...
// Syncing provides information when this nodes starts synchronising with the Contentos network and when it's finished.
...
type SyncingResult struct {
	...
	Status  contentos.SyncProgress `json:"status"`
}
