...
import (
	...
	"github.com/coschain/contentos-go/p2p/depend/common/bitutil"
...
const (
	// bloomServiceThreads is the number of goroutines used globally by an Contentos
...
func (eth *Contentos) startBloomHandlers() {
...
// for the Contentos header bloom filters, permitting blazing fast filtering.
