...
func (*Operation) Descriptor() ([]byte, []int) {
	return fileDescriptor_transaction_adeaaeb42d932979, []int{0}
}
...
type Operation_Op1 struct {
	Op1 *type_proto.AccountCreateOperation `protobuf:"bytes,1,opt,name=op1,oneof"`
}
type Operation_Op2 struct {
	Op2 *type_proto.TransferOperation `protobuf:"bytes,2,opt,name=op2,oneof"`
}
...
func (m *Operation) GetOp1() *type_proto.AccountCreateOperation {
...
func (m *Operation) GetOp2() *type_proto.TransferOperation {
...
func _Operation_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	...
	case 1: // op.op1
		...
		msg := new(type_proto.AccountCreateOperation)
	...
	case 2: // op.op2
		...
		msg := new(type_proto.TransferOperation)
		err := b.DecodeMessage(msg)
...
type Transaction struct {
	...
	Expiration           *type_proto.TimePointSec `protobuf:"bytes,3,opt,name=expiration" json:"expiration,omitempty"`
...
func (*Transaction) Descriptor() ([]byte, []int) {
	return fileDescriptor_transaction_adeaaeb42d932979, []int{1}
}
...
func (m *Transaction) GetExpiration() *type_proto.TimePointSec {
	if m != nil {
		return m.Expiration
	}
	return nil
...
type SignedTransaction struct {
	...
	Signatures           []*type_proto.SignatureType `protobuf:"bytes,2,rep,name=signatures" json:"signatures,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                    `json:"-"`
	XXX_unrecognized     []byte                      `json:"-"`
	XXX_sizecache        int32                       `json:"-"`
}
...
func (*SignedTransaction) Descriptor() ([]byte, []int) {
	return fileDescriptor_transaction_adeaaeb42d932979, []int{2}
}
...
func (m *SignedTransaction) GetSignatures() []*type_proto.SignatureType {
	if m != nil {
		return m.Signatures
	}
	return nil
...
func (*TransactionInvoice) Descriptor() ([]byte, []int) {
	return fileDescriptor_transaction_adeaaeb42d932979, []int{3}
}
...
func (*TransactionWrapper) Descriptor() ([]byte, []int) {
	return fileDescriptor_transaction_adeaaeb42d932979, []int{4}
}
...
type BlockHeader struct {
	Previous              *type_proto.Sha256       `protobuf:"bytes,1,opt,name=previous" json:"previous,omitempty"`
	Timestamp             *type_proto.TimePointSec `protobuf:"bytes,2,opt,name=timestamp" json:"timestamp,omitempty"`
	Witness               string                   `protobuf:"bytes,3,opt,name=witness,proto3" json:"witness,omitempty"`
	TransactionMerkleRoot *type_proto.Sha256       `protobuf:"bytes,4,opt,name=transaction_merkle_root,json=transactionMerkleRoot" json:"transaction_merkle_root,omitempty"`
	XXX_NoUnkeyedLiteral  struct{}                 `json:"-"`
	XXX_unrecognized      []byte                   `json:"-"`
	XXX_sizecache         int32                    `json:"-"`
}
...
func (*BlockHeader) Descriptor() ([]byte, []int) {
	return fileDescriptor_transaction_adeaaeb42d932979, []int{5}
}
...
func (m *BlockHeader) GetPrevious() *type_proto.Sha256 {
	if m != nil {
		return m.Previous
	}
	return nil
...
func (m *BlockHeader) GetTimestamp() *type_proto.TimePointSec {
	if m != nil {
		return m.Timestamp
	}
	return nil
...
func (m *BlockHeader) GetTransactionMerkleRoot() *type_proto.Sha256 {
	if m != nil {
...
type SignedBlockHeader struct {
	...
	WitnessSignature     *type_proto.SignatureType `protobuf:"bytes,2,opt,name=witness_signature,json=witnessSignature" json:"witness_signature,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                  `json:"-"`
	XXX_unrecognized     []byte                    `json:"-"`
	XXX_sizecache        int32                     `json:"-"`
}
...
func (*SignedBlockHeader) Descriptor() ([]byte, []int) {
	return fileDescriptor_transaction_adeaaeb42d932979, []int{6}
}
...
func (m *SignedBlockHeader) GetWitnessSignature() *type_proto.SignatureType {
	if m != nil {
...
func (*SignedBlock) Descriptor() ([]byte, []int) {
	return fileDescriptor_transaction_adeaaeb42d932979, []int{7}
}
...
func (m *Operation_Op1) MarshalTo(dAtA []byte) (int, error) {
	i := 0
	if m.Op1 != nil {
		dAtA[i] = 0xa
		i++
		i = encodeVarintTransaction(dAtA, i, uint64(m.Op1.Size()))
		n2, err := m.Op1.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n2
...
func (m *Operation_Op2) MarshalTo(dAtA []byte) (int, error) {
	i := 0
	if m.Op2 != nil {
		dAtA[i] = 0x12
		i++
		i = encodeVarintTransaction(dAtA, i, uint64(m.Op2.Size()))
		n3, err := m.Op2.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n3
...
func (m *Operation_Op1) Size() (n int) {
	var l int
	_ = l
	if m.Op1 != nil {
		l = m.Op1.Size()
...
func (m *Operation_Op2) Size() (n int) {
	var l int
	_ = l
	if m.Op2 != nil {
		l = m.Op2.Size()
...
func (m *Operation) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			v := &type_proto.AccountCreateOperation{}
			if err := v.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			m.Op = &Operation_Op1{v}
			iNdEx = postIndex
		case 2:
			if wireType != 2 {
			...
			v := &type_proto.TransferOperation{}
			if err := v.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			m.Op = &Operation_Op2{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
...
func (m *Transaction) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			...
			if m.Expiration == nil {
				m.Expiration = &type_proto.TimePointSec{}
			}
...
func (m *SignedTransaction) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			m.Signatures = append(m.Signatures, &type_proto.SignatureType{})
...
func (m *BlockHeader) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			if m.Timestamp == nil {
				m.Timestamp = &type_proto.TimePointSec{}
			}
		...
		case 4:
			...
			if m.TransactionMerkleRoot == nil {
				m.TransactionMerkleRoot = &type_proto.Sha256{}
			}
...
func (m *SignedBlockHeader) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			if m.WitnessSignature == nil {
				m.WitnessSignature = &type_proto.SignatureType{}
			}
...
func init() { proto.RegisterFile("transaction.proto", fileDescriptor_transaction_adeaaeb42d932979) }

var fileDescriptor_transaction_adeaaeb42d932979 = []byte{
	// 694 bytes of a gzipped FileDescriptorProto
	,
}
