...
func (m *ReplayOperation) Reset()         { *m = ReplayOperation{} }
func (m *ReplayOperation) String() string { return proto.CompactTextString(m) }
func (*ReplayOperation) ProtoMessage()    {}
func (*ReplayOperation) Descriptor() ([]byte, []int) {
	return fileDescriptor_c964c0e078f560bc, []int{10}
}

func (m *ReplayOperation) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_ReplayOperation.Unmarshal(m, b)
}
func (m *ReplayOperation) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_ReplayOperation.Marshal(b, m, deterministic)
}
func (m *ReplayOperation) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ReplayOperation.Merge(m, src)
}
func (m *ReplayOperation) XXX_Size() int {
	return xxx_messageInfo_ReplayOperation.Size(m)
}
func (m *ReplayOperation) XXX_DiscardUnknown() {
	xxx_messageInfo_ReplayOperation.DiscardUnknown(m)
}

var xxx_messageInfo_ReplayOperation proto.InternalMessageInfo

func (m *ReplayOperation) GetUuid() string {
	if m != nil {
		return m.Uuid
	}
	return ""
...
func (m *ReplayOperation) GetOwner() *AccountName {
	if m != nil {
		return m.Owner
	}
	return nil
...
func (m *ReplayOperation) GetContent() string {
	if m != nil {
		return m.Content
	}
	return ""
...
func (m *ReplayOperation) GetParentUuid() string {
	if m != nil {
		return m.ParentUuid
	}
	return ""
...
func (m *ReplayOperation) GetBeneficiaries() []*BeneficiaryRouteType {
	if m != nil {
		return m.Beneficiaries
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*ReplayOperation)(nil), "prototype.replay_operation")
}
...
var fileDescriptor_c964c0e078f560bc = []byte{
	...
	0x3c, 0x13, 0x37, 0x6e, 0xbc, 0x06, 0xda, 0xb5, 0x93, 0x38, 0x82, 0xd6, 0x48, 0xed, 0x81, 0xcb,
	...
	0xb2, 0x9f, 0xfb, 0xdd, 0x82, 0xae, 0xc4, 0x24, 0xa2, 0xd3, 0xbb, 0x25, 0x59, 0xa2, 0x63, 0x2f,
	0xd3, 0x79, 0x08, 0x2b, 0x09, 0x95, 0xc8, 0x95, 0x6f, 0x72, 0xe4, 0x64, 0x21, 0x57, 0xbd, 0xd5,
	0x99, 0xee, 0x8a, 0xdb, 0x93, 0xa3, 0x77, 0x87, 0x23, 0xa6, 0xc6, 0x59, 0xd0, 0x0b, 0x45, 0xdc,
	0x0f, 0x45, 0x6a, 0x5e, 0x6e, 0xbf, 0x28, 0x44, 0xa4, 0xc7, 0x23, 0xd1, 0x9f, 0xc7, 0x0c, 0x9a,
	0x46, 0x3c, 0xfb, 0x15, 0x00, 0x00, 0xff, 0xff, 0x64, 0x08, 0xd7, 0xb3, 0x27, 0x08, 0x00, 0x00,
}
