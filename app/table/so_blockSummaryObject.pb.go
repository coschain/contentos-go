...
It is generated from these files:
	app/table/so_blockSummaryObject.proto

It has these top-level messages:
	SoBlockSummaryObject
	SoUniqueBlockSummaryObjectById
*/
package table
...
type SoBlockSummaryObject struct {
	...
	BlockId *prototype.Sha256 `protobuf:"bytes,2,opt,name=block_id,json=blockId" json:"block_id,omitempty"`
}
...
func (*SoBlockSummaryObject) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{0} }
...
func (*SoUniqueBlockSummaryObjectById) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{1} }
...
func init() { proto.RegisterFile("app/table/so_blockSummaryObject.proto", fileDescriptor0) }
