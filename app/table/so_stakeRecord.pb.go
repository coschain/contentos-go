...
func (*SoStakeRecord) Descriptor() ([]byte, []int) {
	return fileDescriptor_so_stakeRecord_8ce77959133a4677, []int{0}
}
...
func (dst *SoStakeRecord) XXX_Merge(src proto.Message) {
	xxx_messageInfo_SoStakeRecord.Merge(dst, src)
}
...
func (*SoMemStakeRecordByRecord) Descriptor() ([]byte, []int) {
	return fileDescriptor_so_stakeRecord_8ce77959133a4677, []int{1}
}
...
func (dst *SoMemStakeRecordByRecord) XXX_Merge(src proto.Message) {
	xxx_messageInfo_SoMemStakeRecordByRecord.Merge(dst, src)
}
...
func (*SoMemStakeRecordByStakeAmount) Descriptor() ([]byte, []int) {
	return fileDescriptor_so_stakeRecord_8ce77959133a4677, []int{2}
}
...
func (dst *SoMemStakeRecordByStakeAmount) XXX_Merge(src proto.Message) {
	xxx_messageInfo_SoMemStakeRecordByStakeAmount.Merge(dst, src)
}
...
func (*SoMemStakeRecordByLastStakeTime) Descriptor() ([]byte, []int) {
	return fileDescriptor_so_stakeRecord_8ce77959133a4677, []int{3}
}
...
func (dst *SoMemStakeRecordByLastStakeTime) XXX_Merge(src proto.Message) {
	xxx_messageInfo_SoMemStakeRecordByLastStakeTime.Merge(dst, src)
}
...
func (*SoUniqueStakeRecordByRecord) Descriptor() ([]byte, []int) {
	return fileDescriptor_so_stakeRecord_8ce77959133a4677, []int{4}
}
...
func (dst *SoUniqueStakeRecordByRecord) XXX_Merge(src proto.Message) {
	xxx_messageInfo_SoUniqueStakeRecordByRecord.Merge(dst, src)
}
...
func init() {
	proto.RegisterFile("app/table/so_stakeRecord.proto", fileDescriptor_so_stakeRecord_8ce77959133a4677)
}

var fileDescriptor_so_stakeRecord_8ce77959133a4677 = []byte{
