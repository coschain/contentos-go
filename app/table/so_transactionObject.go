...
//
func (s *STransactionObjectExpirationWrap) QueryListByOrder(start *prototype.TimePointSec, end *prototype.TimePointSec, maxCount uint32,
	f func(mVal *prototype.Sha256, sVal *prototype.TimePointSec)) error {
	if s.Dba == nil {
		return errors.New("the db is nil")
	}
	if f == nil || maxCount < 1 {
