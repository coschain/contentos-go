...
func (*SoVote) Descriptor() ([]byte, []int) {
	return fileDescriptor_so_vote_6665a95860d75ec2, []int{0}
}
...
func (*SoMemVoteByVoter) Descriptor() ([]byte, []int) {
	return fileDescriptor_so_vote_6665a95860d75ec2, []int{1}
}
...
func (*SoMemVoteByVoteTime) Descriptor() ([]byte, []int) {
	return fileDescriptor_so_vote_6665a95860d75ec2, []int{2}
}
...
func (*SoMemVoteByPostId) Descriptor() ([]byte, []int) {
	return fileDescriptor_so_vote_6665a95860d75ec2, []int{3}
}
...
func (*SoMemVoteByWeightedVp) Descriptor() ([]byte, []int) {
	return fileDescriptor_so_vote_6665a95860d75ec2, []int{4}
}
...
func (*SoMemVoteByUpvote) Descriptor() ([]byte, []int) {
	return fileDescriptor_so_vote_6665a95860d75ec2, []int{5}
}
...
func (*SoListVoteByVoter) Descriptor() ([]byte, []int) {
	return fileDescriptor_so_vote_6665a95860d75ec2, []int{6}
}
...
func (*SoListVoteByVoteTime) Descriptor() ([]byte, []int) {
	return fileDescriptor_so_vote_6665a95860d75ec2, []int{7}
}
...
func (*SoListVoteByPostId) Descriptor() ([]byte, []int) {
	return fileDescriptor_so_vote_6665a95860d75ec2, []int{8}
}
...
func (*SoUniqueVoteByVoter) Descriptor() ([]byte, []int) {
	return fileDescriptor_so_vote_6665a95860d75ec2, []int{9}
}
...
func init() { proto.RegisterFile("app/table/so_vote.proto", fileDescriptor_so_vote_6665a95860d75ec2) }

var fileDescriptor_so_vote_6665a95860d75ec2 = []byte{
