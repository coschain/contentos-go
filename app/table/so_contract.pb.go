...
func (*SoContract) Descriptor() ([]byte, []int) {
	return fileDescriptor_so_contract_a8052378d86aa75d, []int{0}
}
...
func (*SoMemContractById) Descriptor() ([]byte, []int) {
	return fileDescriptor_so_contract_a8052378d86aa75d, []int{1}
}
...
func (*SoMemContractByCreatedTime) Descriptor() ([]byte, []int) {
	return fileDescriptor_so_contract_a8052378d86aa75d, []int{2}
}
...
func (*SoMemContractByAbi) Descriptor() ([]byte, []int) {
	return fileDescriptor_so_contract_a8052378d86aa75d, []int{3}
}
...
func (*SoMemContractByBalance) Descriptor() ([]byte, []int) {
	return fileDescriptor_so_contract_a8052378d86aa75d, []int{4}
}
...
func (*SoMemContractByCode) Descriptor() ([]byte, []int) {
	return fileDescriptor_so_contract_a8052378d86aa75d, []int{5}
}
...
func (*SoMemContractByApplyCount) Descriptor() ([]byte, []int) {
	return fileDescriptor_so_contract_a8052378d86aa75d, []int{6}
}
...
func (dst *SoMemContractByApplyCount) XXX_Merge(src proto.Message) {
	xxx_messageInfo_SoMemContractByApplyCount.Merge(dst, src)
}
...
func (*SoMemContractByUpgradeable) Descriptor() ([]byte, []int) {
	return fileDescriptor_so_contract_a8052378d86aa75d, []int{7}
}
...
func (dst *SoMemContractByUpgradeable) XXX_Merge(src proto.Message) {
	xxx_messageInfo_SoMemContractByUpgradeable.Merge(dst, src)
}
...
func (*SoMemContractByHash) Descriptor() ([]byte, []int) {
	return fileDescriptor_so_contract_a8052378d86aa75d, []int{8}
}
...
func (dst *SoMemContractByHash) XXX_Merge(src proto.Message) {
	xxx_messageInfo_SoMemContractByHash.Merge(dst, src)
}
...
func (*SoListContractByCreatedTime) Descriptor() ([]byte, []int) {
	return fileDescriptor_so_contract_a8052378d86aa75d, []int{9}
}
...
func (*SoListContractByApplyCount) Descriptor() ([]byte, []int) {
	return fileDescriptor_so_contract_a8052378d86aa75d, []int{10}
}
...
func (dst *SoListContractByApplyCount) XXX_Merge(src proto.Message) {
	xxx_messageInfo_SoListContractByApplyCount.Merge(dst, src)
}
...
func (*SoUniqueContractById) Descriptor() ([]byte, []int) {
	return fileDescriptor_so_contract_a8052378d86aa75d, []int{11}
}
...
func init() {
	proto.RegisterFile("app/table/so_contract.proto", fileDescriptor_so_contract_a8052378d86aa75d)
}

var fileDescriptor_so_contract_a8052378d86aa75d = []byte{
