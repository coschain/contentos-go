...
func (s *SoGlobalWrap) Md(f func(tInfo *SoGlobal)) error {
	...
	sa := s.getGlobal()
	if sa == nil {
		return errors.New("fail to get table SoGlobal")
	}
...
func (s *SoGlobalWrap) handleFieldMd(t FieldMdHandleType, so *SoGlobal, fMap map[string]interface{}) error {
	if so == nil || fMap == nil {
