...
func (m *SoMemTransactionObjectByTrxId) XXX_Merge(src proto.Message) {
	xxx_messageInfo_SoMemTransactionObjectByTrxId.Merge(m, src)
}
...
func (m *SoMemTransactionObjectByExpiration) XXX_Merge(src proto.Message) {
	xxx_messageInfo_SoMemTransactionObjectByExpiration.Merge(m, src)
}
...
func (*SoListTransactionObjectByExpiration) Descriptor() ([]byte, []int) {
	return fileDescriptor_b0e5dbc6d4c15723, []int{3}
}
...
func (*SoUniqueTransactionObjectByTrxId) Descriptor() ([]byte, []int) {
	return fileDescriptor_b0e5dbc6d4c15723, []int{4}
}
