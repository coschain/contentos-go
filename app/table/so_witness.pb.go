...
func (*SoWitness) Descriptor() ([]byte, []int) {
	return fileDescriptor_so_witness_070e8e241195a0bd, []int{0}
}
...
func (*SoListWitnessByOwner) Descriptor() ([]byte, []int) {
	return fileDescriptor_so_witness_070e8e241195a0bd, []int{1}
}
...
func (*SoUniqueWitnessByOwner) Descriptor() ([]byte, []int) {
	return fileDescriptor_so_witness_070e8e241195a0bd, []int{2}
}
...
func init() {
	proto.RegisterFile("app/table/so_witness.proto", fileDescriptor_so_witness_070e8e241195a0bd)
}

var fileDescriptor_so_witness_070e8e241195a0bd = []byte{
