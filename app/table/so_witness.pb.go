...
func (*SoWitness) Descriptor() ([]byte, []int) {
	return fileDescriptor_so_witness_7db83032908b8e71, []int{0}
}
...
func (*SoMemWitnessByOwner) Descriptor() ([]byte, []int) {
	return fileDescriptor_so_witness_7db83032908b8e71, []int{1}
}
...
func (*SoMemWitnessByWitnessScheduleType) Descriptor() ([]byte, []int) {
	return fileDescriptor_so_witness_7db83032908b8e71, []int{2}
}
...
func (dst *SoMemWitnessByWitnessScheduleType) XXX_Merge(src proto.Message) {
	xxx_messageInfo_SoMemWitnessByWitnessScheduleType.Merge(dst, src)
}
...
func (*SoMemWitnessByCreatedTime) Descriptor() ([]byte, []int) {
	return fileDescriptor_so_witness_7db83032908b8e71, []int{3}
}
...
func (*SoMemWitnessByUrl) Descriptor() ([]byte, []int) {
	return fileDescriptor_so_witness_7db83032908b8e71, []int{4}
}
...
func (*SoMemWitnessByVoteCount) Descriptor() ([]byte, []int) {
	return fileDescriptor_so_witness_7db83032908b8e71, []int{5}
}
...
func (*SoMemWitnessByLastConfirmedBlockNum) Descriptor() ([]byte, []int) {
	return fileDescriptor_so_witness_7db83032908b8e71, []int{6}
}
...
func (*SoMemWitnessByTotalMissed) Descriptor() ([]byte, []int) {
	return fileDescriptor_so_witness_7db83032908b8e71, []int{7}
}
...
func (*SoMemWitnessByPowWorker) Descriptor() ([]byte, []int) {
	return fileDescriptor_so_witness_7db83032908b8e71, []int{8}
}
...
func (*SoMemWitnessBySigningKey) Descriptor() ([]byte, []int) {
	return fileDescriptor_so_witness_7db83032908b8e71, []int{9}
}
...
func (*SoMemWitnessByLastWork) Descriptor() ([]byte, []int) {
	return fileDescriptor_so_witness_7db83032908b8e71, []int{10}
}
...
func (*SoMemWitnessByRunningVersion) Descriptor() ([]byte, []int) {
	return fileDescriptor_so_witness_7db83032908b8e71, []int{11}
}
...
func (*SoMemWitnessByLastAslot) Descriptor() ([]byte, []int) {
	return fileDescriptor_so_witness_7db83032908b8e71, []int{12}
}
...
func (*SoListWitnessByOwner) Descriptor() ([]byte, []int) {
	return fileDescriptor_so_witness_7db83032908b8e71, []int{13}
}
...
func (*SoListWitnessByVoteCount) Descriptor() ([]byte, []int) {
	return fileDescriptor_so_witness_7db83032908b8e71, []int{14}
}
...
func (*SoUniqueWitnessByOwner) Descriptor() ([]byte, []int) {
	return fileDescriptor_so_witness_7db83032908b8e71, []int{15}
}
...
func init() {
	proto.RegisterFile("app/table/so_witness.proto", fileDescriptor_so_witness_7db83032908b8e71)
}

var fileDescriptor_so_witness_7db83032908b8e71 = []byte{
