// copy from wagon/validate and customized it
// Copyright 2017 The go-interpreter Authors.  All rights reserved.
// Use of this source code is governed by a BSD-style
// license that can be found in the LICENSE file.
// Modify by contentos Authors
package vmvalidator
...
func verifyBody(fn *wasm.FunctionSig, body *wasm.FunctionBody, module *wasm.Module) (*mockVM, error) {
	...
	for {
		...
		case ops.F32Const, ops.F64Const:
			...
			//	return vm, err
			//}
		case ops.I32ReinterpretF32, ops.I64ReinterpretF64, ops.F32ReinterpretI32, ops.F64ReinterpretI64:
			return vm, ErrProhibitFloat
		case ops.F32Eq, ops.F32Ne, ops.F32Lt, ops.F32Gt, ops.F32Le, ops.F32Ge, ops.F64Eq, ops.F64Ne, ops.F64Lt,
			ops.F64Gt, ops.F64Le:
			return vm, ErrProhibitFloatComparision
		...
		case ops.F32Abs, ops.F32Neg, ops.F32Ceil, ops.F32Floor, ops.F32Trunc, ops.F32Nearest, ops.F32Sqrt,
			...
			return vm, ErrProhibitFloatOperation
		...
		case ops.F32Load, ops.F64Load, ops.F32Store, ops.F64Store:
			return vm, ErrProhibitFloat
