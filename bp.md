...
```
  ...
  LocalBpName = your account name (Account name created in the first step)
  LocalBpPrivateKey = private key of your Contentos account (The private key generated by the account just created in the first step)
